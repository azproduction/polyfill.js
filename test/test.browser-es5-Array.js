...
test('Array.isArray', function() {
    ...
    require('../polyfills/es5/Array.isArray.js');
...
test('Array.prototype.every', function () {
    require('../polyfills/es5/Array.prototype.every.js');
