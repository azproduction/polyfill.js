...
test('Date.now', function() {
    require('../polyfills/es5/Date.now.js');
    assert.ok(Date.now);
...
test('Date.prototype.toISOString', function() {
    require('../polyfills/es5/Date.prototype.toISOString.js');
...
test('Function.prototype.bind', function() {
    require('../polyfills/es5/Function.prototype.bind.js');
    assert.ok(Function.prototype.bind);
});

test('Object.keys', function() {
    require('../polyfills/es5/Object.keys.js');
    assert.ok(Object.keys);
});

test('String.prototype.trim', function() {
    require('../polyfills/es5/String.prototype.trim.js');
