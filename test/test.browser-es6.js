...
test('Number.isFinite', function() {
    require('../polyfills/es6/Number.isFinite.js');
...
test('Number.isInteger', function() {
    require('../polyfills/es6/Number.isInteger.js')  ;
...
test('Number.isNaN', function() {
    require('../polyfills/es6/Number.isNaN.js') ;
...
test('Number.toInteger', function() {
    require('../polyfills/es6/Number.toInteger.js');
...
test('String.prototype.endsWith', function() {
    require('../polyfills/es6/String.prototype.endsWith.js');
...
test('String.prototype.startsWith', function() {
    require('../polyfills/es6/String.prototype.startsWith.js');
...
test('String.prototype.toArray', function() {
    require('../polyfills/es6/String.prototype.toArray.js');
